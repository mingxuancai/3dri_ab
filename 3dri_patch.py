...
if __name__ == "__main__":
    ...
    inter_tensor = torch.zeros((200,200),device=device)
    ...
    for epoch in range(args.num_epochs):
        ...
        if args.patch_gap == 1:
            pred_forward = utils.patch_convolution_100(recon_obj, patch_psf_tensor, device=device)
        elif args.patch_gap == 2:
            pred_forward = utils.patch_interp_conv22(recon_obj, patch_psf_tensor, inter_tensor)
        
        total = opt_loss.total_variation_loss_2d(pred_forward[50:150,50:150], args.tv_weight, device=device)
        mseloss = opt_loss.mse_loss(pred_forward[50:150,50:150], meas_tensor[50:150,50:150])
        l1loss = opt_loss.L1_loss(pred_forward[50:150,50:150], args.l1_weight)
        ...
        with torch.no_grad():
            print(f'Reconstruction after iteration {epoch}, loss {mseloss.item():.4e}, l1 {l1loss.item():.4e}, tv {total.item():.4e}')
    ...
    losslist_cpu = [tensor for tensor in loss_list]
